  ...
  <div class="body">
    ...
    <div class="sec">
      ...
      <div class="note">
        ...
        &nbsp;&nbsp;默认走 <b>🛟 流媒体兜底</b>：先在 CF 三族里挑「真的能上 Google」
        的接入点，整族都被判死时自动降到 <b>🌐 落地出口</b>，整批换掉出口 IP
        （CF 的共享出口被 Google 判成机房时，只有换出口能救）。见下面
        「一直能用」区块。<br>
        &nbsp;&nbsp;想手动钉某一条就往下选 Proton线路 / Windscribe线路 ——
        🌐 落地出口 是<b>粘</b>的，选定不换。<br>
    ...
    <div class="sec">
      <div class="sec-t">一直能用 · 三层自动恢复</div>
      <div class="note">
        ...
        🎬 流媒体自动 / 🛟 流媒体兜底 / Proton-自动 / WS-自动：
        这几个组里「换一个目标站接受的出口」比「延迟低 20ms」重要得多。<br>
        <br>
        <b>第二层 · 流媒体族是「粘」的</b>（300 秒一轮 / 换手阈值 150ms）<br>
        ...
        <b>🛟 流媒体兜底</b>（fallback）：它按顺序取第一个活的，会一路降到
        <b>🌐 落地出口</b>，把出口 IP 整批换成 Opera / Proton / Windscribe
        的机房。<br>
        <br>
    ...
    <div class="sec">
      ...
      <div class="note">
        ...
        就能看到。客户端里的用法完全不变：<b>🚀 节点选择 → ♻️ 自动选择</b>，
